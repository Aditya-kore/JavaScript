...
function updateScore(card, activePlayer) {
    if (card === 'A'){
    // If adding 11 keeps score below 21, add ace as 11. otherwide add 1
...
// computes winner and returns the winner
function computeWinner() {
    let winner;

    if (YOU['score']<=21) {
        // condition: when higher score than dealer or when dealer busts but you dont
